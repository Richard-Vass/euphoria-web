...
const labels: Record<string, Record<string, string>> = {
  ...
  cs: {
    ...
    subtitle: "Rezervujte si privátní pokoj v Euphoria",
    step1: "Pokoj",
    step2: "Datum",
    step3: "Čas",
    step4: "Údaje",
    ...
    available: "Volné",
    booked: "Obsazené",
    partiallyBooked: "Částečně obsazené",
    blocked: "Zablokované",
    closed: "Zavřeno",
    ...
    successMsg: "Vaše rezervace byla automaticky potvrzena.",
    successDetail: "Detaily rezervace byly zaslány na váš email.",
    backToCalendar: "Nová rezervace",
    back: "Zpět",
    continue: "Pokračovat",
    fri: "Pá",
    sat: "So",
